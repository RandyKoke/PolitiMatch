...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Sans ça, ":attribute" est remplacé par le nom technique du champ tel
    | quel (ex. "username", "password_confirmation") dans une phrase par
    | ailleurs entièrement française — pas acceptable pour un public
    | francophone. Uniquement les champs réellement présents dans les
    | formulaires de l'app (RegisterRequest, LoginRequest, UpdateAvatarRequest,
